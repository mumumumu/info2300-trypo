	...
	<body>
		...
		<?php 
				...
				else
				{
					...
					print("<p class=\"staff\"> <a href=\"aboutUs.php\">Back</a></p>");
					print("<p class=\"staff\"> <a href=\"adminStaff.php\">Administrative Staff</a></p>");
					$query1 = "SELECT sectionHeader, sectionContent FROM PageContent WHERE page='Staff' ORDER BY id";
